...
export const japaneseToLatinMap: Record<string, string> = {
  // ==================== KATA MAJEMUK (diprioritaskan karena panjang) ====================
  // Waktu
  ...
  // Horror / game
  '恐怖': 'kyoufu', '潜入': 'sennyuu', '亡霊': 'bourei',
  '幽霊': 'yuurei', '廃墟': 'haikyo', '生存': 'seizon',
  '感染': 'kansen', '変異': 'heni', '脅威': 'kyoui',
  '悪夢': 'akumu', '暗闇': 'kurayami', '怪物': 'kaibutsu',
  '武器': 'buki', '謎': 'nazo', '探索': 'tansaku',
  '逃亡': 'toubou', '生き残り': 'ikinokori',

  // Lainnya
  '日本語': 'nihongo', '東京': 'toukyou', '大阪': 'oosaka',
  '名前': 'namae', '言葉': 'kotoba', '物語': 'monogatari',
  '冒険': 'bouken', '戦闘': 'sentou', '勝利': 'shouri',
  '敗北': 'haiboku', '仲間': 'nakama', '敵': 'teki',

  // ==================== KOMBINASI SMALL KANA (ティ, ディ, dsb.) ====================
  // Ini adalah kunci terpanjang ke-2, jadi akan dicocokkan sebelum karakter tunggal
  'ティ': 'ti', 'ディ': 'di',
  ...
  // Hiragana small kana combos (jarang, tapi lengkapi)
  'てぃ': 'ti', 'でぃ': 'di',
  ...
  'ゃ': 'ya', 'ゅ': 'yu', 'ょ': 'yo',
  'ぁ': 'a', 'ぃ': 'i', 'ぅ': 'u', 'ぇ': 'e', 'ぉ': 'o',
  'っ': '', // sokuon ditangani di applySokuon
  ...
  // Katakana kana kecil standalone
  'ャ': 'ya', 'ュ': 'yu', 'ョ': 'yo',
  'ァ': 'a', 'ィ': 'i', 'ゥ': 'u', 'ェ': 'e', 'ォ': 'o',
  'ッ': '', // sokuon

  // Tanda vokal panjang (diabaikan)
  'ー': '',
  ...
  '肉': 'niku',
  '駅': 'eki', '店': 'mise', '家': 'ie',
  '町': 'machi', '村': 'mura', '都': 'to', '市': 'shi', '館': 'kan',
  '車': 'kuruma', '船': 'fune',
  '電': 'den', '話': 'wa', '機': 'ki', '械': 'kai',
  '恐': 'kyou', '怖': 'fu', '深': 'fuka', '潜': 'sen',
  '廃': 'hai', '墟': 'kyo', '変': 'hen', '異': 'i',
  '暗': 'an', '闇': 'yami', '怪': 'kai', '物': 'butsu',
  '謎': 'nazo', '索': 'saku', '逃': 'to', '亡': 'bou',
  '霊': 'rei', '幽': 'yuu',
  '遊': 'yuu', '戯': 'gi', '画': 'ga', '音': 'oto',
  '楽': 'raku', '曲': 'kyoku',
  '死': 'shi', '体': 'tai', '威': 'i', '脅': 'kyou',
  '見': 'mi', '聞': 'ki', '読': 'yo', '書': 'ka',
  '買': 'ka', '行': 'i', '来': 'ku', '帰': 'kae',
  '出': 'de', '入': 'ire', '始': 'haji', '終': 'owa',
  '開': 'hira', '閉': 'to', '作': 'tsuku', '使': 'tsuka',
