...
image:
  ...
  caption: "User Interface Adogen v1.0 - Minimalist Engineering Style"
...
repoUrl: "https://github.com/bimaakbar/adogen" # Tambahkan repo jika ada
draft: false
featured: true
challenge: "Kontributor stok foto menghabiskan 60% waktu untuk urusan administratif metadata. Masalahnya adalah analisa visual masal (batch) dengan biaya rendah namun tetap akurat."
solution: "Integrasi Vision AI (Llama 3.2 & Pixtral) melalui Cloudflare Workers dengan implementasi client-side image resizing untuk efisiensi bandwidth."
result: "Memangkas waktu input metadata dari 5 menit menjadi kurang dari 10 detik per gambar, serta mendukung batch upload hingga 50 gambar sekaligus."
metrics:
  performance: 98
  accessibility: 100
  seo: 100
