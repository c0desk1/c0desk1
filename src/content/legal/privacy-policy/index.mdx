...
lastUpdated: 2026-05-23T22:10
lang: en
seo:
  title: Privacy Policy | C0desk1
  description: Read C0desk1's privacy policy to understand how we collect, use, and protect your personal data, including our use of Ezoic, Google, and Yandex services.
  noIndex: false
---
...
We comply with applicable privacy laws, including the General Data Protection Regulation (GDPR) and ePrivacy Directive, and we work with advertising partners such as **Ezoic**, **Google AdSense**, and **Yandex Ads** to display relevant ads.
...
- To serve relevant advertisements through **Ezoic**, **Google AdSense**, and **Yandex Ads**
...
|---------|----------|---------------|----------------|
| **Ezoic** | Ad mediation, caching, analytics | US/EU | [Ezoic Privacy](https://g.ezoic.com/privacy/) |
...
| **Advertising Cookies** | Deliver relevant ads, limit ad frequency | Ezoic, Google AdSense, Yandex Ads |

### Consent Management (CMP)
We use **Ezoic's Consent Management Platform (CMP)** to obtain and manage your cookie preferences. When you first visit our website, a banner will appear allowing you to accept, reject, or customize your cookie settings. You can change your preferences at any time by clicking the "Cookie Preferences" link in the footer.
...
## 5. Advertising & Ezoic Mediation

This website uses **Ezoic** as an ad mediation platform. Ezoic works with multiple ad exchanges and networks (including Google AdSense and Yandex Ads) to display relevant advertisements.

### How Ezoic works:
- When you visit our site, Ezoic and its partners may collect data about your browsing behavior (e.g., pages viewed, time spent, approximate location, device type).
- This data is used to build a profile of your interests and show you personalized ads.
- Ezoic conducts real-time auctions among its demand partners to display the highest-paying relevant ad.

### What data does Ezoic collect?
...
You can learn more in Ezoic's privacy policy: [https://g.ezoic.com/privacy/](https://g.ezoic.com/privacy/)
...
- **Ad tracking data**: up to 13 months (Ezoic & partners)
...
To exercise these rights, contact us at: **[hallo@c0desk1.my.id](mailto:hallo@c0desk1.my.id)**. We will respond within 30 days.
...
**Email:** [Email](mailto:hallo@c0desk1.my.id)  
**Website:** [c0desk1](https://c0desk1.my.id)  
