...
## Botol Leher (Bottleneck) Kontributor
...
### Astro 6 & Tailwind 4
Menggunakan teknologi terbaru untuk memastikan *First Contentful Paint* (FCP) di bawah 1 detik. Ringan, minimalis, dan sangat cepat.

### Vision AI Integration
Adogen menggunakan model **Llama 3.2 Vision** dan **Pixtral**. AI ini tidak menebak berdasarkan nama file, tapi benar-benar "melihat" objek, warna, suasana, dan konsep di dalam gambar lu.

### Client-Side Processing
Gambar lu di-*resize* di browser sebelum dikirim ke API. Ini menghemat kuota data lu dan mempercepat proses unggah.

### CSV Batch Export
Begitu selesai, Lu tidak perlu *copy-paste* satu per satu. Klik satu tombol, dan file CSV siap di-impor ke dashboard Adobe Stock.

## Filosofi "Gratis Tapi Premium"
...
## Cara Memulai Workflow Masa Depan

<Steps>
### Siapkan API Key
Ambil API Key gratis lu di **[Groq](https://console.groq.com/)** atau **[Mistral AI](https://console.mistral.ai/)**.

### Konfigurasi
Masukkan key di panel **System Configuration** **[Adogen](https://dev-adogen.bimasaktiakbarr.workers.dev/)**.

### Upload & Analisa
Taruh semua foto lu, dan saksikan AI bekerja merakit metadata untuk lu.

### Export
Unduh CSV, upload ke Adobe Stock, dan fokuslah kembali untuk memotret!
</Steps>

## Fokus ke Kreativitas, Biarkan AI Mengurus Data
...
> Tertarik mencoba? Langsung meluncur ke [Adogen](https://dev-adogen.bimasaktiakbarr.workers.dev/). / Bima Akbar