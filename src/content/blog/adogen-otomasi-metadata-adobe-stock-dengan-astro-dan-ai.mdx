...
---
import Callcout from "@/components/mdx/Callout.astro";
...
<Callout type="info">*Tertarik mencoba? Langsung meluncur ke **[Adogen](https://dev-adogen.bimasaktiakbarr.workers.dev/)**.*</Callcout>
