---
title: "How to Automate Windows with PowerShell!"
slug: "automasi-windows-dengan-powershell"
...
featured: false
seo:
  title: "PowerShell Scripts to Auto-Rename & Delete Files"
  description: "Tired of organizing files manually? Let me teach you how to create a PowerShell script to auto-rename & delete files on Windows. Error-proof & practical — let your PC do the work!"
...
Many ask, <q>Why not just use CMD, dude?</q>. Well, PowerShell is way *smarter* than **CMD**. It can read objects. So if you want to find files larger than 1GB or files that haven't been opened in a year, **PowerShell** can find them super easily.
