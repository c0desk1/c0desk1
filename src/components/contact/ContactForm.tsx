...
export default function ContactForm() {
  ...
  const inputBase =
    'w-full px-3 py-2.5 text-body-14 rounded-lg ' +
  ...
  if (status === 'sent') {
    return (
      ...
      >
        ...
        <p className="text-body-14 text-muted">
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-body-13 text-subtle">Usually replies within 24h</p>
      ...
      {status === 'error' && (
        <p className="text-body-13 text-center" style={{ color: 'var(--error)' }}>
