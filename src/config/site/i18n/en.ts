export const en = {
    ...
    newsletterNote: 'No spam. You can unsubscribe at any time.',
    newsletterInvalid: 'Please enter a valid email address.',
    newsletterExists: 'Email address already registered.',
    ...
    HeroDesc: "Exploring digital workflows, AI tools, music, anime, and games from the perspective of a modern creator in the age of automation.",
    ...
    blog_HeroDesc: "Behind-the-scenes notes on systems, creativity, and things I find interesting. A journal for every fragment I'm learning.",
    ...
    p_HeroDesc: "A collection of web development projects and some visual experiments.",

    p_FeaturedPosts: "Featured Project",
    p_latestPost: "Latest Project",
    p_AllProjects: "All Projects",
    p_relatedProjects: "Related Projects",

    p_Empty: "No projects published yet.",

    p_Header: "Portfolio Header",
    p_ImageContent: "Portfolio Content Image",
    p_MetricsCase: "Portfolio Metrics & Case Studies",
    p_Content: "Portfolio Content",
    p_Gallery: "Gallery",
    p_RelatedContent: "Portfolio Related Content",
    ...
    cookiePreference: "Cookie preferences",
    cookieValuePrivacy: "We value your privacy",
    cookieSelectCookie: "Choose which cookies you allow",
    close: "Close",
    cookieFunctional: "Functional",
    cookieFunctionalDesc: "Necessary for the site to function. Cannot be disabled.",
    cookieAnalytics: "Analytics",
    cookieAnalyticsDesc: "Helps us understand how visitors interact with content.",
    cookieAds: "Ads & Personalization",
    cookieAdsDesc: "Shows ads relevant to you. Disable if you don't want ads.",
    ...
    cookieChangePreference: "Change cookie preferences",
