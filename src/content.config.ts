...
const seoSchema = z.object({
  title: z
    .string()
    .max(100, "Judul terlalu panjang untuk SEO maksimal")
    .optional(),
  description: z
    .string()
    .min(10, "Deskripsi terlalu pendek")
    .max(160, "Deskripsi terlalu panjang untuk SEO")
    .optional(),
...
const blogCollection = defineCollection({
  ...
  schema: ({ image }) =>
    z.object({
      ...
      tags: z
        .array(z.string().max(30, "Tag maksimal 30 karakter"))
        .max(5, "Maksimal 5 tags")
        .default([]),

      categories: z
        .array(z.string().max(30, "Category maksimal 30 karakter"))
...
const portfolioCollection = defineCollection({
  ...
  schema: ({ image }) =>
    z.object({
      ...
      techStack: z
        .array(z.string().max(40, "Tech stack maksimal 40 karakter"))
  ...
  schema: z.object({
    ...
    socialLinks: z
      .object({
        github: z
          .string()
          .url({ message: "GitHub URL harus valid" })
          .optional(),
        twitter: z
          .string()
          .url({ message: "Twitter URL harus valid" })
          .optional(),
        linkedin: z
          .string()
          .url({ message: "LinkedIn URL harus valid" })
          .optional(),
      })
      .optional(),
    seo: seoSchema.optional(),
